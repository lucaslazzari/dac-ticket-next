    ...
    >
      ...
      <div className="p-6 border-b border-[#1d6478]">
        {isOpen ? (
          <Link href="/" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#44C0CF] to-[#134C60] flex items-center justify-center shadow-lg">
              <div className="w-6 h-6 rounded-md border-2 border-white" />
            </div>
            <span className="text-xl font-bold tracking-wide">DAC System</span>
          </Link>
        ) : (
          <Link href="/" className="flex justify-center">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#44C0CF] to-[#134C0CF] flex items-center justify-center shadow-lg">
              <div className="w-6 h-6 rounded-md border-2 border-white" />
            </div>
          </Link>
        )}
      ...
      {isOpen && (
        <div className="p-4 border-t border-[#1d6478]">
          <div className="text-xs text-gray-400 text-center">© 2025 DAC System</div>
        </div>
      )}
    </aside>
  );
