...
export default function Home() {
  ...
  const stats = [
    { label: 'Total Revenue', value: '$45.2K', change: '+12.5%', positive: true },
    { label: 'Active Users', value: '2,345', change: '+8.2%', positive: true },
    { label: 'Pending Tickets', value: '23', change: '-15.3%', positive: false },
    { label: 'Satisfaction Rate', value: '94.5%', change: '+2.1%', positive: true }
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-[#134C60] to-[#44C0CF] rounded-2xl shadow-xl p-8 text-white">
        <h1 className="text-4xl font-bold mb-2">Welcome to DAC</h1>
        <p className="text-lg text-gray-100">Integrated management system</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        <h2 className="text-xl font-bold text-[#134C60] mb-4">Recent Activity</h2>
          ...
          {[1, 2, 3].map((item) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-800">New activity registered</p>
